...
std_traj =  np.std(accepted_traj, axis=0)
...
a =   mean_traj * ((mean_traj*(1-mean_traj)/std_traj**2) - np.ones(n_dim))
b = (1-mean_traj) * ( (mean_traj*(1-mean_traj)/std_traj**2) - np.ones(n_dim))
